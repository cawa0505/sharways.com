...
<head>
    ...
    <style>
    	*{font-family:'Helvetica';}
	    body{width:auto; max-width:690px;margin:0 auto;font-size:13px;}
	    ...
	    table.report-card td {padding: 0.5em;  padding-left:20px; border:1px solid #2e2e2e;text-align: left;}
...
<body>
    <div style="@if((isset($print_options) && ! gbv($print_options, 'no_border')) || ! isset($print_options)) border:1px dashed #696969; @endif margin-top: 10px;">
        <div style="padding:2px;background: #ffffff;">
