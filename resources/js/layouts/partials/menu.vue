	...
	<ul id="sidebarnav">
        ...
        <li v-show="moduleMenu && showMenu('student') && hasAnyPermission(['list-registration','list-student','edit-roll-number','generate-student-id-card','list-student-attendance','promote-student','terminate-student'])">
            ...
            <ul aria-expanded="false" class="collapse">
                ...
                <li v-if="(hasPermission('list-student') || hasPermission('list-class-teacher-wise-student')) && showMenu('student_list')"><router-link to="/student/list"><i class="fas fa-angle-double-right"></i> {{trans('student.student_list')}}</router-link></li>
