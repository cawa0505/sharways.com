                    ...
                    <div class="modal-container modal-lg">
                        ...
                        <div class="modal-body">
                            <slot name="body">
		            			...
		            			<p>{{trans('student.date_of_admission')}}: {{student_record.date_of_entry | moment}}</p>
		            			<p>{{trans('student.date_of_promotion')}}: {{student_record.admission.date_of_admission | moment}}</p>
