	        ...
	        <div class="row">
	            ...
	            <div class="col-12 col-sm-8">
	                <div class="form-group">
	                    ...
	                    <autosize-textarea v-model="terminationForm.termination_remarks" rows="2" name="termination_remarks" :placeholder="trans('student.termination_remarks')"></autosize-textarea>
