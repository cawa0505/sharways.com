                                                    ...
                                                    <span v-else>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <button class="dropdown-item custom-dropdown-menu" @click.prevent="setTransaction(fee_installment)">
                                                                    <i class="fas fa-arrow-circle-right"></i> {{trans('finance.receipt_detail')}}
                                                                </button>
                                                                <button class="dropdown-item custom-dropdown-menu" :key="fee_installment.id" v-confirm="{ok: confirmEmptyReceiptDelete(fee_installment)}" v-if="!getInstallmentPaid(fee_installment) && hasPermission('cancel-fee-payment')">
...
<script>
    ...
    export default {
        components : {datepicker,studentSummary,feePaymentForm,feePaymentParentForm,feeDetail},
        data() {
            return {
