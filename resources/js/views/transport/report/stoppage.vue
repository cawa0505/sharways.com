        ...
        <div class="page-titles">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 class="text-themecolor">{{trans('transport.stoppage_wise_report')}}</h3>
                </div>
                <div class="col-12 col-sm-6">
                ...
                <div class="col-12">
						        ...
						        <div class="row">
						            <div class="col-12 col-sm-3">
						                <div class="form-group">
						                    ...
						                    <v-select label="name" v-model="selected_transport_stoppage" name="transport_stoppage_id" id="transport_stoppage_id" :options="transport_stoppages" :placeholder="trans('transport.select_stoppage')" @select="onTransportStoppageSelect" @remove="onTransportStoppageRemove">
						                    </v-select>
						                </div>
						            </div>
						        </div>
		            ...
		            <div class="card">
		                <div class="card-body">
		                        ...
		                        <table class="table table-sm">
		                            ...
		                            <tbody>
		                                <tr v-for="transport_route_student in transport_route_students.data">
		                                    ...
		                                    <td v-text="transport_route_student.transport_route_detail.transport_route.name"></td>
                                            <td>
		                    ...
		                    <module-info v-if="!transport_route_students.total" module="transport" title="stoppage_wise_report_module_title" description="stoppage_wise_report_module_description" icon="list">
		                    </module-info>
	...
	export default {
		...
		methods: {
            ...
            getReport(page){
                ...
                axios.get('/api/transport/report/stoppage?page=' + page + url)
                    .then(response => {
            ...
            print(){
                let loader = this.$loading.show();
                axios.post('/api/transport/report/stoppage/print',{filter: this.filter})
                    .then(response => {
            ...
            pdf(){
                let loader = this.$loading.show();
                axios.post('/api/transport/report/stoppage/pdf',{filter: this.filter})
                    .then(response => {
                        loader.hide();
