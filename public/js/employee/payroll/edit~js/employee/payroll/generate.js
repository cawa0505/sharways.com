  ...
  computed: {
    getTotalEarningSalary: function getTotalEarningSalary() {
      ...
      this.payrollForm.pay_heads.forEach(function (pay_head) {
        total += parseInt(pay_head.type == 'earning' ? pay_head.amount || 0 : 0);
      });
      return total;
    },
    getTotalDeductionSalary: function getTotalDeductionSalary() {
      var total = 0;
      this.payrollForm.pay_heads.forEach(function (pay_head) {
        total += parseInt(pay_head.type == 'deduction' ? pay_head.amount || 0 : 0);
      });
      return total;
    },
...
//# sourceMappingURL=generate.js.map?id=e93cd9d16a96d5bf1a97