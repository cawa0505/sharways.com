...
class RecordRepository
{
    ...
    public function getStudentsForObservationRecord($params = array())
    {
        ...
        $date_of_exam = $exam_schedule->records->last()->date;
    ...
    public function store($params = array())
    {
        ...
        foreach ($marks as $mark) {
            ...
            if ($is_absent) {
                ...
                array_push($student_marks, array('id' => $student_record_id, 'is_absent' => false, 'assessment_details' => array_values($assessment_details), 'comment' => $comment));
