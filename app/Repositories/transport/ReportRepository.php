...
class ReportRepository
{
    ...
    public function getRouteWiseData($params)
    {
        ...
        return $this->transport_route_student->with([
            ...
            'studentRecord',
            'studentRecord.studentFeeRecords',
            'studentRecord.studentFeeRecords.feeInstallment',
            'studentRecord.studentFeeRecords.feeInstallment.transportFee',
            'studentRecord.studentFeeRecords.feeInstallment.transportFee.transportFeeDetails',
            'studentRecord.batch',
