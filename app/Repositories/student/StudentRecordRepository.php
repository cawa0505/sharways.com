...
class StudentRecordRepository
{
    ...
    public function updateRecord(StudentRecord $student_record, $params)
    {
        ...
        if ($batch->id != $student_record->batch_id) {
            ...
            if ($fee_allocation->course_id && $fee_allocation->course_id == $student_record->batch->course_id) {
    ...
    public function setFee(StudentRecord $student_record, $params)
    {
        ...
        foreach ($fee_groups as $fee_group) {
            ...
            foreach ($installments as $installment) {
                ...
                $due_date            = gv($installment, 'due_date');
                $late_fee            = gv($installment, 'late_fee');
    ...
    private function validateInput($fee_installments, $params = array())
    {
        ...
        $can_make_partial_payment = false;
    ...
    private function createStudentFeeRecordDetail(StudentFeeRecord $student_fee_record, $installment, $amount, $transaction_id, $zero_payment = 1)
    {
