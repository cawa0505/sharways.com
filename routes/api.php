...
Route::group(['middleware' => ['jwt.auth']], function () {
    ...
    Route::get('/transfer-certificate/pre-requisite', 'Academic\TransferCertificateController@preRequisite');
    Route::get('/transfer-certificate', 'Academic\TransferCertificateController@index');
    Route::get('/transfer-certificate/{uuid}', 'Academic\TransferCertificateController@show');
    Route::post('/transfer-certificate', 'Academic\TransferCertificateController@store');
    Route::post('/transfer-certificate/print', 'Academic\TransferCertificateController@print');
    Route::post('/transfer-certificate/pdf', 'Academic\TransferCertificateController@pdf');
    Route::patch('/transfer-certificate/{uuid}', 'Academic\TransferCertificateController@update');
    Route::delete('/transfer-certificate/{uuid}', 'Academic\TransferCertificateController@destroy');
    ...
    Route::get('/visitor/log/{id}', 'Reception\VisitorLogController@show');
    ...
    Route::patch('/visitor/log/{id}', 'Reception\VisitorLogController@update');
    Route::delete('/visitor/log/{id}', 'Reception\VisitorLogController@destroy');

    Route::get('/visitor/message', 'Reception\VisitorMessageController@index');
    Route::get('/visitor/message/{id}', 'Reception\VisitorMessageController@show');
    ...
    Route::delete('/visitor/message/{id}', 'Reception\VisitorMessageController@destroy');
    /*
